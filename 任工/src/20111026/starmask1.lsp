...
(Defun C:tmpGetSelT( / x)
  (initget 1 "S O A")
  (setq x (getkword "Select Objects手选/One Layer单层/<All Layer所有层>:"))
)
(Defun C:tmpGetKW(kw msg / x)
  (initget 0 kw)
  (setq x (getkword msg))
)
(Defun C:tmpGetSel( / DD layerName widen findf DCL_F DCL_ID DD PATH)
  ;(initget 1 "S O A")
