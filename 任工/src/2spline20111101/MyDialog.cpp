...
BEGIN_MESSAGE_MAP(CMyDialog, CAcUiDialog)
	...
	ON_BN_CLICKED(IDC_TEXT2PL3, OnBnClickedText2pl3)
	ON_BN_CLICKED(IDC_Do5s, OnBnClickedDo5s)
	ON_BN_CLICKED(IDC_DIMMINI, OnBnClickedDimmini)
END_MESSAGE_MAP()
...
void CMyDialog::OnBnClickedText2pl3()
{
	EndDialog(IDC_TEXT2PL3);
}

void CMyDialog::OnBnClickedDo5s()
{
	EndDialog(IDC_Do5s);
	starDo5s();
}

void CMyDialog::OnBnClickedDimmini()
{
	EndDialog(IDC_DIMMINI);
	starDimmini();
}
